...
// Passport.js provides strategies that allow authentication across major platforms such as Facebook, Twitter and Google. For this assignment, will be using the passport-local strategy

app.use(passport.initialize());
app.use(passport.session());

// Initialize bodyparser. We turn on the feature to parse json data.
